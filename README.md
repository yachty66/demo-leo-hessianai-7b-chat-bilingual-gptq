...
# Banana.dev leo-hessianai-7B-chat-bilingual-GPTQ starter template

This is a leo-hessianai-7B-chat-bilingual-GPTQ starter template from [Banana.dev](https://www.banana.dev) that allows on-demand serverless GPU inference.
...
1. [Fork this](https://github.com/yachty66/demo-leo-hessianai-7b-chat-bilingual-gptq/fork) repository to your own Github account.
